...
CREATE TABLE pictures(
    ...
    post_id	INT REFERENCES posts(id) ON DELETE CASCADE,
    pictureURL TEXT,
    album_id INT REFERENCES albums(id) ON DELETE CASCADE DEFAULT NULL
);
...
INSERT INTO users (username, password, bio, proPicURL)
    VALUES ('kwong', 'admin123', 'NYC ABC. DM for beats. I have always had a passion for creative and innovative technology that can change the way our society lives. https://soundcloud.com/kj_wongg', 'https://scontent-lga3-1.xx.fbcdn.net/v/t1.0-9/35428358_10155525285981088_195203712392626176_n.jpg?_nc_cat=108&_nc_ohc=hFrvRM-lxQ0AX-loDFi&_nc_ht=scontent-lga3-1.xx&oh=fd27939bb7eab472adb49de8e39fde50&oe=5EBDF5B5'),
